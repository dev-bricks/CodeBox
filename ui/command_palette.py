...
class CommandPaletteDialog(QDialog):
    ...
    def _collect_commands(self):
        ...
        quick_actions = [
            ...
            ("Ausführen", "Debuggen starten", "Ctrl+F5", self.main_window.debug_current),
            ("Ausführen", "Debug: Weiter (Continue)", "", self.main_window.debug_continue),
            ("Ausführen", "Debug: Einzelschritt (Step Over)", "F10", self.main_window.debug_step_over),
            ("Ausführen", "Debug: Hineinspringen (Step Into)", "F11", self.main_window.debug_step_into),
            ("Ausführen", "Debug: Herausspringen (Step Out)", "Shift+F11", self.main_window.debug_step_out),
